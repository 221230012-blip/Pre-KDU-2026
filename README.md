...
| **C** | **C**onsistency |It prevents conflicts during simultaneous operations. Multiple users may be streaming, updating views, inserting shows or adding analytics queries. |
